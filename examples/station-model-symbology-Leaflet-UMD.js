                        ...
                        */
                        ...
                        case 11:                    
                            if (decodedData.present_weather != null) {
                                ...
                                if (decodedData.weather_indicator.automatic == true) {
                                    ...
                                    if (decodedData.weather_indicator.value == 5) ; else if (decodedData.weather_indicator.value == 6 || 
                                    ...
                                    if (decodedData.weather_indicator.value == 2 || decodedData.weather_indicator.value == 5) ; else if (decodedData.weather_indicator.value == 3 || decodedData.weather_indicator.value == 6 || 
                        ...
                        case 23:
                            if (decodedData.hasOwnProperty("precipitation_indicator")) {
                                w = h = 13.33;
                                if (decodedData.precipitation_indicator.value == 3) ; else if (decodedData.precipitation_indicator.value == 4){
